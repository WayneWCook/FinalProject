 ...
 * 5/13/2020
 * CECFC/FRCC Java 160
 * This program displays all of the story. It is also a parent class for CorrectAnswer. It works for the main class.
 */
public class ThePlot {
    ...
    public String Stories() {           //Is story. Will print the story in correct order because of for loop in main.
        if (storyNum == 1) return "Your character rides in on a horse into an abandoned ghost town. You step into a building to check for supplies. " +
                "\nYou look in and around the abandoned saloon. You see a dark room.\n" +
                "Do you want to continue to the room?\n" +
                "1. Yes\n" +
                "2. No\n" +
                "Choice: ";
        else if (storyNum == 2) return "You continue to the room. You hear a large rumbling surrounding the room. A large green light is going in the walls. " +
        ...
        else if (storyNum == 3) return "Well, " + Polite() + ", you ain’t leaving this place alive. And when you get to hell tell ‘em Johnny Trainwreck sent you!”\n" +
                ...
                "3. Lay down and die";
        else if (storyNum == 4) return "\"ARGH, well you got lucky. See if you can handle this next attack.\"\n" +
                ...
                "3. Lay down and die";
        else if (storyNum == 5) return "\"That seems weirdly lucky, like something is helping you.\"\n" +
        ...
        else if (storyNum == 6) return "\"ARRRRRRGGHH!\" and Johnny falls over, and dies.\n" +
                ...
                "3. Try and dodge";
        else if (storyNum == 7) return "\"UGH, your a harder kill than we thought.\" " +
                "Two whips are being whipped at you.\n" +
                "1. Take a whipping like the loser you are\n" +
                "2. Catch both whips and shoot both\n" +
                "3. Lay down and die";
        else if (storyNum == 8) return "Their final attack will be high pitched screaming.\n" +
                "1. SHUT UP AND KILL THEM BOTH\n" +
                "2. Run away and never look back\n" +
                "3. Lay down and die while your head hurts";
        else if (storyNum == 9) return "The Twins explode and they slink back to whatever place they need to be.\n" +
        ...
        else if (storyNum == 10) return "2.@#$%^&*(&^%$##&*&*\n" +
                "1. Ahh ymg' ah mgephai geb\n" +
                "2. Ahh ymg' ah mgephai geb\n" +
                "3. Ahh ymg' ah mgephai geb";
        else if (storyNum == 11) return "3.$%^&UYGTFYR$^%&^&*(\n" +
                "1. Zhro ya\n" +
                "2. Zhro ya\n" +
                "3. Zhro ya";
        else if (storyNum == 12) return "4.$%^&*(UIYUGTFR^$\n" +
                "1. Fahf ah weird nafl l' bug ah'legeth\n" +
                "2. Fahf ah weird nafl l' bug ah'legeth\n" +
                "3. Fahf ah weird nafl l' bug ah'legeth";
        else if (storyNum == 13) return "\"You see black everywhere, yet you somehow see the black being evaporate. Then nothing.\"\n" +
